...
from cnnmodel.modelefficientnet import ImageOnlyEfficientNetV2S
...
# === Model ===
model = ImageOnlyEfficientNetV2S(num_classes=len(class_names)).to(device)
...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_efficientnet_imageonly.pth")
...
plt.tight_layout()
plt.savefig("training_curve_efficientnet_imageonly.png")
plt.show()
