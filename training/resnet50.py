...
from cnnmodel.modelresnet50 import ImageOnlyResNet50
...
# === Model ===
model = ImageOnlyResNet50(num_classes=len(class_names)).to(device)
...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_resnet50_imageonly.pth")
...
plt.tight_layout()
plt.savefig("training_curve_resnet50_imageonly.png")
plt.show()
